  ...
  const projects = [
    {
      ...
      location: 'Καλαμάτα',
      description:
        'Εγκατάσταση φωτοβολταϊκού συστήματος net billing με μπαταρίες.',
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-12">
            <div>
              ...
              <p className="mt-4 text-gray-600 max-w-2xl leading-relaxed">
                Επιλεγμένα έργα φωτοβολταϊκών συστημάτων με έμφαση στην ποιότητα εγκατάστασης,
                την αισθητική και την ενεργειακή απόδοση.
              </p>
            </div>

            <a
              href="#contact-form"
              className="bg-green-700 hover:bg-green-800 text-white px-6 py-4 rounded-2xl transition inline-block text-center"
            >
              Ζητήστε Μελέτη
            </a>
          </div>
